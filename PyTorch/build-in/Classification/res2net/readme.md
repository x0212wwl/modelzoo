...
Res2Net 是一种新的构建卷积神经网络模块的方法，通过在一个残差块内构建分层的残差类连接，以更细粒度的级别表示多尺度特征，从而提高了各类视觉任务的性能。
...
```bash
python weloTrain.py --name train --arch res2net --dataset cifar100 --datapath ../data --batch_size 128 --epochs 100
